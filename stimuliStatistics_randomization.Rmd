...
control_new$n.char <- word_sample$num1
#sentences
sentences <- data.frame(ns1_sample$wordControl,word_sample$wordControl,ns3_sample$wordControl,ns4_sample$wordControl,ns5_sample$wordControl,ns6_sample$wordControl)
#
SentencesSubject <- SentencesSubject[,as.factor(c(
  "stimuli","Number","S1","S2","S3","S4","S5","S6"
))]
```
